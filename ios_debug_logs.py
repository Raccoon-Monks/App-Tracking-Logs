...
if __name__ == "__main__":
    ...
    enabled_platforms = capture_registry.enabled_platforms(operating_system.IOS)

    instructions = ui_data.Instructions(operating_system.IOS, list(enabled_platforms))
    ...
    try:
        capture_registry.dispatch(operating_system.IOS, platform, args, no_argument)
